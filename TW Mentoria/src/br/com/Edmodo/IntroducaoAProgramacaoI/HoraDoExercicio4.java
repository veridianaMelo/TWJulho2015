...
public class HoraDoExercicio4 {
	...
	public static void main(String[] args) {
		...
		String idade = JOptionPane.showInputDialog("Quantos anos você tem? Primeiro digite os anos");
		...
		System.out.println("A sua idade em dias são " + idadeEmDias + ".");
		System.out.println("A sua idade em horas são " + idadeEmHoras + ".");
	}
